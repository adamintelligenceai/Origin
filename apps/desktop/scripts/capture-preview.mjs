...
await page.screenshot({ path: `${out}/approved-receipt.png`, fullPage: true });
...
await page.screenshot({ path: `${out}/chief.png`, fullPage: true });

await page.getByRole("button", { name: /Decisions/ }).click();
await page.getByRole("heading", { name: "Decisions." }).waitFor();
await page.screenshot({ path: `${out}/decisions.png`, fullPage: true });

await page.getByRole("button", { name: /Connections/ }).click();
await page.getByRole("heading", { name: "Connections." }).waitFor();
await page.screenshot({ path: `${out}/connections.png`, fullPage: true });
...
await web.screenshot({ path: `${out}/web-home.png`, fullPage: true });
